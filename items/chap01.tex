...
Если в содержании не появляется список литературы -- действия аналогичны. 2 раза запустить компиляцию, запустить компиляцию библиографии, 2 раза запустить компиляцию.
