...
[Предыдущий шаблон](https://github.com/mmcs-sfedu/mmcs_sfedu_thesis)
...
Используются свободные шрифты (включены в репозиторий проекта):

* [Free Fonts](https://www.gnu.org/software/freefont/)
* [XITS Math](https://fontlibrary.org/ru/font/xits-math)

_(При необходимости используемые шрифты можно задать в `.cls` файле)_
