...
Используемые шрифты входят в состав репозитория _(при необходимости их можно изменить в [`.cls`](https://github.com/sanyarnd/sfedu-mmcs-latex-thesis-template/blob/master/sfedu-mmcs-thesis.cls#L111) файле)_.
